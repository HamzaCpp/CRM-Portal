...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{asset('frontend/plugins/images/favicon.png')}}">
    <!-- Custom CSS -->
...
<header class="topbar" data-navbarbg="skin5">
    ...
    <script src="{{asset('frontend/plugins/bower_components/gmaps/gmaps.min.js')}}"></script>
    <script src="{{asset('frontend/plugins/bower_components/gmaps/jquery.gmaps.js')}}"></script>
    <!--Custom JavaScript -->
