...
<body>
                        ...
                        <div class="card white-box p-0">
                            ...
                            <div class="comment-widgets">
                                ...
                                <div class="d-flex flex-row comment-row p-3 mt-0">
                                    <div class="p-2"><img src="<?php echo e(asset('frontend/plugins/images/users/varun.jpg')); ?>" alt="user" width="50" class="rounded-circle"></div>
                                ...
                                <div class="d-flex flex-row comment-row p-3">
                                    <div class="p-2"><img src="<?php echo e(asset('frontend/plugins/images/users/genu.jpg')); ?>" alt="user" width="50" class="rounded-circle"></div>
                                ...
                                <!-- Comment Row -->
                                <div class="d-flex flex-row comment-row p-3">
                                    <div class="p-2"><img src="<?php echo e(asset('frontend/plugins/images/users/ritesh.jpg')); ?>" alt="user" width="50" class="rounded-circle"></div>
                                    <div class="comment-text ps-2 ps-md-3 w-100">
                                ...
                                <ul class="chatonline">
                                    <li>
                                        ...
                                        <a href="javascript:void(0)" class="d-flex align-items-center"><img
                                                src="<?php echo e(asset('frontend/plugins/images/users/varun.jpg')); ?>" alt="user-img" class="img-circle">
                                            <div class="ms-2">
                                    ...
                                    <li>
                                        ...
                                        <a href="javascript:void(0)" class="d-flex align-items-center"><img
                                                src="<?php echo e(asset('frontendplugins/images/users/genu.jpg')); ?>" alt="user-img" class="img-circle">
                                            <div class="ms-2">
                                    ...
                                    <li>
                                        ...
                                        <a href="javascript:void(0)" class="d-flex align-items-center"><img
                                                src="<?php echo e(asset('frontend/plugins/images/users/ritesh.jpg')); ?>" alt="user-img" class="img-circle">
                                            <div class="ms-2">
                                    ...
                                    <li>
                                        ...
                                        <a href="javascript:void(0)" class="d-flex align-items-center"><img
                                                src="<?php echo e(asset('frontend/plugins/images/users/arijit.jpg')); ?>" alt="user-img" class="img-circle">
                                            <div class="ms-2">
                                    ...
                                    <li>
                                        ...
                                        <a href="javascript:void(0)" class="d-flex align-items-center"><img
                                                src="<?php echo e(asset('frontend/plugins/images/users/govinda.jpg')); ?>" alt="user-img"
                                                class="img-circle">
                                            <div class="ms-2">
    ...
    <script src="<?php echo e(asset('frontendjs/app-style-switcher.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('frontendjs/pages/dashboards/dashboard1.js')); ?>"></script>
</body>

</html><?php /**PATH C:\xampp\htdocs\laravel\crm\resources\views/frontend\dashboard.blade.php ENDPATH**/ ?>