    ...
    <div class="main-wrapper">
        ...
        <div class="error-box">
            <div class="error-body text-center">
                ...
                <a href="<?php echo e(route('dashboard')); ?>" class="btn btn-danger btn-rounded waves-effect waves-light mb-5 text-white">Back to home</a>
            </div>
        </div>
        <!-- ============================================================== -->
        <!-- Login box.scss -->
...
</html><?php /**PATH C:\xampp\htdocs\laravel\crm\resources\views/frontend\404.blade.php ENDPATH**/ ?>