          ...
          <div class="page-breadcrumb bg-white">
              <div class="row align-items-center">
                  <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    ...
                    <a class="nav-link active btn btn-primary ms-10" aria-current="page" href="<?php echo e(route('createp')); ?>">Create</a>
                  </div>
              </div>
              <!-- /.col-lg-12 -->
          </div>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href=<?php echo e(url('editp',$project->id)); ?> class='btn btn-info'>Edit</a></td>
                            <td><a href=<?php echo e(url('deletep',$project->id)); ?> class="btn btn-danger">Delete</a></td>
                        </tr>
...
</html><?php /**PATH C:\xampp\htdocs\laravel\crm\resources\views/frontend/projects/project.blade.php ENDPATH**/ ?>