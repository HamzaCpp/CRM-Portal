...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo e(asset('frontend/plugins/images/favicon.png')); ?>">
    <!-- Custom CSS -->
...
<header class="topbar" data-navbarbg="skin5">
    ...
    <script src="<?php echo e(asset('frontend/plugins/bower_components/gmaps/gmaps.min.js')); ?>"></script>
    <script src="<?php echo e(asset('frontend/plugins/bower_components/gmaps/jquery.gmaps.js')); ?>"></script>
    <!--Custom JavaScript -->
    <script src="<?php echo e(asset('frontend/js/custom.js')); ?>"></script>
</body>

</html><?php /**PATH C:\xampp\htdocs\laravel\crm\resources\views/frontend\map-google.blade.php ENDPATH**/ ?>